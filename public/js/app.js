...
var container = document.getElementById("app"); //allow you to access arbitrary properties, even ones that don’t exist
var pokemons = 150;
...
var getPokemon = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://pokeapi.co/api/v2/pokemon/" + id)]; //Response?
            case 1:
                data = _a.sent() //Response?
                ;
